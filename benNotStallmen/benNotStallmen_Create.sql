...
;
insert into Product values('CUP005678', 13.55, 2.00, 'BLACK', 'A001', 3, 50, 'Be organized is Bens motto, well maybe. What ever it is that is his guruish montra you will certainly know where to stick your pens and pencils. If you do not just ask he will tell you. This baby talks to you. So when your board forget Stallman ask Ben.', NULL, NULL, NULL, 'Pencil Cup')
;
insert into Product values('TSHPEN1515', 25.00, 2.00, 'ORANGE', 'A003', 1, 50, 'Get this wonderfully comfortable, 100% inorganic cotton t-shirt with Ben, not Stallmans, fantastic mug on it. We only sell large shirts because that is what Ben wears and why would you want to wear anything else?', NULL, NULL, NULL, 'Shirt')
;
insert into Product values('BEN151234', 10.00, 1.25, 'BLUE', 'A001', 8, 50, 'Do you like Beer? Do you like cider? Well Ben does. So buy these pint glasses and enjoy that brew that you do. Heck if you play your cards right maybe you someday can drink one with Stallman, he could always use a friend.', NULL, NULL, NULL, 'Pint Glass')
