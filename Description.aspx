    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <div style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" >
                <asp:Label ID="productName" CssClass="descriptionLabel" runat="server" Text="test" />
            </div>
            <h2 class="contentHeader">Description</h2>
            <div style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" >
                <asp:Label ID="productDescription" CssClass="descriptionLabel" runat="server" Text="test" />
            </div>
            ...
            <div style="margin-left: auto; margin-right: auto; text-align: center; margin-bottom: 20px;" runat="server">
                <asp:Label ID="productPrice" CssClass="descriptionLabel" runat="server" Text="test" />
            </div>
        </div>
        <div id="footer">
